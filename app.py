...
st.title(op[0])
st.write("For getting spam 'copy below sentence and paste it' or write something like this:" )
...
st.write("check out this github [link](https://github.com/antonysandesh/Spam_Ham)")
